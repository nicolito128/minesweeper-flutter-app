...
final Map<String, Palette> paletteKV = {
  "classic": const Palette(
    id: "classic",
    name: "Classic",
  ...
  "hackerman": const Palette(
    id: "hackerman",
    name: "Hackerman",
    primary: Color.fromARGB(255, 40, 44, 52),
    secondary: Color.fromARGB(255, 147, 235, 122),
  ...
  "sunset": const Palette(
    id: "sunset",
    name: "Sunset",
    primary: Color.fromARGB(255, 204, 89, 63),
    secondary: Color.fromARGB(255, 246, 216, 96),
    background: Color.fromARGB(255, 79, 27, 38),
...
final List<Palette> paletteList = paletteKV.values.toList();
